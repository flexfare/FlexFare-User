package com.flexfare.android.user.views;
...
public class CurvedLayout extends FrameLayout {
    ...
    private CurvedSettings settings;
    ...
    public void init(Context context, AttributeSet attrs) {
        settings = new CurvedSettings(context, attrs);
    ...
    private Path createClipPath() {
        ...
        switch (settings.getPosition()){
            case CurvedSettings.POSITION_BOTTOM:{
            ...
            case CurvedSettings.POSITION_TOP:
                if (settings.isCropInside()) {
                ...
                break;
            case CurvedSettings.POSITION_LEFT:
                if (settings.isCropInside()) {
                    path.moveTo(width, 0);
                    path.lineTo(0, 0);
                ...
                break;
            case CurvedSettings.POSITION_RIGHT:
                if (settings.isCropInside()) {
                    path.moveTo(0, 0);
                    path.lineTo(width, 0);
