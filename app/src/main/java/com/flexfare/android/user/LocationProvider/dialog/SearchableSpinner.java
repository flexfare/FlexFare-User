package com.flexfare.android.user.LocationProvider.dialog;
...
public class SearchableSpinner extends AppCompatSpinner implements View.OnTouchListener,
    ...
    private OnPositionClicked onPositionClickedListener;
    ...
    public void setOnPositionClickedListener(OnPositionClicked onPositionClickedListener) {
    ...
    public void set_titleString(String _titleString) {
    ...
    public void onSearchableItemClicked(Object item, int position) {
        ...
        //FUCK IT .. THE POSITION IS ALL I NEED
    ...
    public interface OnPositionClicked {
